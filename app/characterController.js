angular.module("marvelApp", []).controller("CharacterController", function($q, $http) {
    ...
    characterController.listar = (nome) => {
        var promise = $q.defer();
        var list = [];
        $http.get(`https://gateway.marvel.com:443/v1/public/characters?ts=1&apikey=5a237863b3cc2061003cbbc4fe20dc06&hash=bd4b447a65ef5d6b174f87cf9db6d2db&nameStartsWith=${nome}`).then(
            function(result){
